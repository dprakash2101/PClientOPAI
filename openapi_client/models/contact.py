...
class Contact(BaseModel):
    ...
    date_time_created: Optional[datetime] = Field(default=None, alias="dateTimeCreated")
    is_deleted: Optional[StrictBool] = Field(default=None, alias="isDeleted")
    __properties: ClassVar[List[str]] = ["id", "firstName", "lastName", "nickName", "age", "dateTimeCreated", "isDeleted"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "age": obj.get("age"),
            "dateTimeCreated": obj.get("dateTimeCreated"),
